...
class AppConfig:
    ...
    LLM_MODEL_ID = os.environ.get(
        "LLM_MODEL_ID",
        config.get("ai", "llm_model_id", fallback=config.get("ai", "vision_model_name", fallback="xai.grok-4.3"))
    )
    ...
    SELECT_AI_MODEL_ID = os.environ.get("SELECT_AI_MODEL_ID", "xai.grok-4.3")
